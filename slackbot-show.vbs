...
If false and WScript.Arguments.Count = 0 Then Syntax
'If WScript.Arguments.Count > 0 and WScript.Arguments(0) = "/?" Then Syntax
...
wshShell.Run Trim( "node config-pl.js" ), 0, False
